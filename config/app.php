    ...
    */
    ...
    'identifier_systems' => [
        'patient' => [
            ...
            'rekam-medis' => 'http://sys-ids.kemkes.go.id/' . env('organization_id') . '/rekam-medis',
            'bpjs' => 'http://sys-ids.kemkes.go.id/' . env('organization_id') . '/bpjs',
        ],
        'practitioner' => [
            'nik' => 'https://fhir.kemkes.go.id/id/nik',
        ...
        'organization' => 'http://sys-ids.kemkes.go.id/organization/' . env('organization_id'),
        'procedure' => 'http://sys-ids.kemkes.go.id/procedure/' . env('organization_id'),
        'questionnaireresponse' => 'http://sys-ids.kemkes.go.id/questionnaireresponse/' . env('organization_id'),
        'servicerequest' => 'http://sys-ids.kemkes.go.id/servicerequest/' . env('organization_id'),
    ],
