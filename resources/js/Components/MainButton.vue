...
<template>
    <button :class="{ 'pointer-events-none': isLoading }"
        class="relative inline-flex justify-center items-center px-7 py-2.5 rounded-xl font-semibold text-sm transition ease-in-out duration-150 hover:shadow-lg">
