        ...
        <div class="flex flex-row pt-7">
            <aside class="hidden xl:h-full xl:fixed xl:flex xl:flex-col xl:shrink-0 xl:w-72">
                ...
                <ul class="space-y-2">
                    ...
                    <li>
                        <NavLink :href="route('gawatdarurat')" :active="route().current('gawatdarurat')">
                            <span class="mr-2">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" viewBox="0 0 24 24" fill="none">
                                    <path
                                        ...
                                        stroke-linejoin="round" />
                                    <path d="M12 12V14M12 14L9.5 16.5M12 14L14.5 16.5" stroke="currentColor"
                                        stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                            </span>
                            <span class="pt-1">Gawat Darurat</span>
                        </NavLink>
                    </li>
                    <li>
                    ...
                    <li v-if="$page.props.auth.user.roles[0].name === 'admin'">
                        <NavLink :href="route('usermanagement')" :active="route().current('usermanagement')">
                            ...
                            <span class="pt-1">User Management</span>
                        </NavLink>
                    </li>
                    <li>
                        <NavLink :href="route('medication')" :active="route().current('medication')">
                            <span class="mr-2">
                                ...
                                <img width="24" height="24" src="https://img.icons8.com/material-two-tone/24/pill.png" alt="pill"/>
                            </span>
                            <span class="pt-1">Medication</span>
                        </NavLink>
                    </li>
                    <li>
                        <NavLink :href="route('finance')" :active="route().current('finance')">
                            <span class="mr-2">
                                ...
                                <img width="24" height="24" src="https://img.icons8.com/material-two-tone/24/money.png" alt="pill"/>
                            </span>
