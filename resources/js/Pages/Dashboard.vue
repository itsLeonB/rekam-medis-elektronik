    ...
    <AuthenticatedLayout>
        <div class="flex flex-row justify-between bg-white overflow-hidden rounded-xl shadow h-20 md:h-36 md:rounded-2xl mb-8">
            ...
            <div class="hidden md:block md:mr-8">
                <img src="storage/images/welcome-onboard.png" class="h-full mx-auto" alt="">
            </div>
        </div>
        ...
        <div class="flex flex-col space-y-8 md:flex-row md:space-x-8 md:space-y-0">
            <div class="p-5 flex flex-col basis-3/5 h-fit bg-white overflow-hidden shadow sm:rounded-xl">
                ...
                <VueApexCharts width="100%" height="320px" type="bar" :options="jumlahPasienPerBulanOptions"
                    :series="jumlahPasienPerBulan">
                </VueApexCharts>
            </div>
            <div class="p-5 flex flex-col basis-2/5 h-fit bg-white overflow-hidden shadow sm:rounded-xl">
                ...
                <VueApexCharts width="100%" height="367px" type="donut" :options="persebaranPasienOptions"
                    :series="persebaranPasien">
                </VueApexCharts>
            </div>
        </div>
    </AuthenticatedLayout>
