    ...
    <div>
        <form @submit.prevent="submit">
            <div class="my-2 w-full">
                <h3 class="font-semibold text-secondhand-orange-300 mt-2">Durasi Nyeri</h3>
                <div class="flex">
                    <div class="w-full md:w-12/12">
                        <InputLabel for="text" value="Durasi Nyeri" />
                        <div class="flex items-center">
                            <TextInput v-model="resourceForm.text" id="text" type="number" class="text-sm mt-1 mr-2 block w-10/12"
                                placeholder="Durasi Nyeri" required />
