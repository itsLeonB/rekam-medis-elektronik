    ...
    <div>
        <form @submit.prevent="submit">
            <div class="my-2 w-full">
                <h3 class="font-semibold text-secondhand-orange-300 mt-2">Skala Nyeri</h3>
                <div class="flex">
                    <div class="w-full md:w-12/12">
                        <InputLabel for="text" value="Skala Nyeri - Numeric Rating Scale" />
                        <div class="flex">
                            <TextInput v-model="resourceForm.text" id="text" type="number" class="text-sm mt-1 block w-full"
...
const submit = () => {
    ...
    const submitResource = {
        ...
        "issued": currentTime,
        "valueInteger": resourceForm.value.text
    };
