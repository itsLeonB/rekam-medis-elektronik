<template>
    <div>
        <form @submit.prevent="submit">
            <div class="my-2 w-full" v-for="(field, index) in keluhan" :key="index">
                <h3 v-if="index !== 0" class="font-semibold text-secondhand-orange-300 mt-2">Keluhan Utama {{ (index + 1) }}
                </h3>
                <h3 v-else class="font-semibold text-secondhand-orange-300 mt-2">Keluhan Utama</h3>
                <div class="flex">
                    <div class="w-full md:w-7/12 mr-2">
                        <InputLabel for="keluhan" value="Keluhan Pasien" />
                        <div class="flex">
                            <Multiselect v-model="keluhan[index].code" mode="single" placeholder="Keluhan"
                    ...
                    <div class="w-full md:w-5/12">
                        ...
                        <div class="flex">
                            <Multiselect v-model="keluhan[index].clinical" mode="single" placeholder="Status" :object="true"
                                :options="clinicalStatusList" label="display" valueProp="code" track-by="code" class="mt-1"
            ...
            <div class="flex justify-between">
                <SecondaryButtonSmall type="button" @click="addField" class="teal-button-text">+ Tambah Keluhan
...
const addField = () => {
    ...
    keluhan.value.push(keluhanData);
};

const removeField = (index) => {
    keluhan.value.splice(index, 1);
};
