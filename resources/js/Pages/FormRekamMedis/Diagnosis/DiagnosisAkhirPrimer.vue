    ...
    <div>
        <form @submit.prevent="submit">
            <div class="my-2 w-full">
                <h3 class="font-semibold text-secondhand-orange-300 mt-2">Diagnosa Primer/Kerja</h3>
                <div class="flex">
...
const submit = () => {
    ...
    const submitResource = {
        ...
        "verificationStatus": {
            "coding": [
                {
                    "system": resourceForm.value.verificationStatus.system,
                    "code": resourceForm.value.verificationStatus.code,
                    "display": resourceForm.value.verificationStatus.display
                }
            ]
        },
        "code": {
