    ...
    <AuthenticatedLayout>
        ...
        <div class="h-screen flex flex-row pt-4 xl:pt-7">
                ...
                <ul class="space-y-2">
                   ...
                   <li>
                        <NavButton @click="formSection = 5" :active="formSection === 5">
                            ...
                            <span class="pt-1">Resep Obat</span>
                        </NavButton>
                    </li>
                    <li>
                ...
                <div class="bg-original-white-0 shadow rounded-xl md:rounded-2xl mb-8 p-6 md:py-8 md:px-10">
                    ...
                    <div class="flex flex-col lg:flex-row">
                        ...
                        <div class="w-full lg:w-1/2 py-2 lg:pr-7 lg:pb-0">
                            ...
                            <div class="space-y-4">
                                <KeluhanUtama :encounter_reference="encounter_reference"
                        ...
                        <div class="w-full lg:w-1/2 py-2 lg:pl-7">
                            ...
                            <div class="space-y-4">
                                <Nadi ref="nadi" :encounter_reference="encounter_reference"
                                    :subject_reference="subject_ref" :practitioner_reference="practitioner_ref" />
                                ...
                                <Diastole ref="diastole" :encounter_reference="encounter_reference"
                                    :subject_reference="subject_ref" :practitioner_reference="practitioner_ref" />
                                <Suhu ref="suhu" :encounter_reference="encounter_reference"
                                    :subject_reference="subject_ref" :practitioner_reference="practitioner_ref" />
                                <div class="w-full flex justify-end mt-2 mr-3">
                                    <MainButtonSmall @click="vitalSubmit" class="teal-button text-original-white-0">
                                        Submit
                                    </MainButtonSmall>
                                </div>
                            </div>
            ...
            <div v-show="formSection === 9" class="min-h-full px-5 md:px-10 xl:pl-80 xl:pr-14 pb-10 w-full">
                <div class="bg-original-white-0 shadow rounded-xl md:rounded-2xl mb-8 p-6 md:py-8 md:px-10">
                    <h1 class="text-2xl font-bold text-secondhand-orange-300">Kondisi saat Meninggalkan RS dan Cara
                        Keluar
                    </h1>
                    <div class="flex flex-col lg:flex-row">
                        <!-- Kiri -->
        ...
        <template #responsivecontent>
            ...
            <ResponsiveNavButton @click="formSection = 5" :active="formSection === 5"> 5. Resep Obat
            </ResponsiveNavButton>
            <ResponsiveNavButton @click="formSection = 6" :active="formSection === 6"> 6. Tatalaksana
            </ResponsiveNavButton>
            <ResponsiveNavButton @click="formSection = 7" :active="formSection === 7"> 7. Prognosis
            </ResponsiveNavButton>
...
import ResepObat from '@/Pages/FormRekamMedis/PeresepanObat/ResepObat.vue'
import RekomendasiObat from '@/Pages/FormRekamMedis/PeresepanObat/RekomendasiObat.vue'
