<template>
    <AuthenticatedLayout>
        ...
        <div class="bg-original-white-0 overflow-hidden shadow rounded-xl md:rounded-2xl mb-8 p-6 md:py-8 md:px-10">
            <h1 class="text-2xl font-bold text-neutral-black-300">Edit User</h1>
            <p class="mb-3 text-base font-normal text-neutral-grey-100">Halaman untuk mengedit user.</p>
            <form>
                <div>
                ...
                <div class="mt-4">
                    <InputLabel for="password" value="Ubah Password" />
                ...
                <div class="mt-4">
                    <InputLabel for="password_confirmation" value="Konfirmasi Ubah Password" />
                    <div class="relative p-0 rounded-xl border-none text-neutral-black-300">
...
const submit = async () => {
    try {
        const response = form.put(route('users.update', {'user_id': props.user_id}));
    } catch (error) {
