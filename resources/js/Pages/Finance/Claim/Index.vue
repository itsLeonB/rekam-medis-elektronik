        ...
        <div
            ...
            <div class="md:py-8">
                <span class="inline-flex">
                    <h1 class="text-2xl font-bold text-neutral-black-300">Daftar Claim</h1>
                </span>
                <p class="mb-3 text-base font-normal text-neutral-grey-100">Lihat dan cari <i>Claim</i> yang telah
                    dibuat
                </p>
                <Link v-if="['admin', 'keuangan'].includes($page.props.auth.user.roles[0].name)"
                    :href="route('finance.claim.new')" as="button"
