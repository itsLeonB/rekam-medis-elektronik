<template>
    <div ref="printArea">
        ...
        <div v-if="encounters && encounters[0]" class="w-full flex div-encounter">
         ...
         <div v-if="encounters && encounters[0]" class="my-2 w-full div-resep">
            ...
            <table class="w-full mx-auto text-base text-left text-neutral-grey-200 data-resep">
                <tbody class="w-full">
                    ...
                    <tr v-for="(item, index) in encounters[0].medicationRequests" :key="index" style="font-size: 14px;">
                        <td class="font-normal">{{ index + 1 }}.</td>
                        <td class="font-normal" v-if="item.medicationReference">{{ item.medicationReference.display }}</td>
                        <td class="font-normal" v-if="item.dosageInstruction && item.dosageInstruction[0]">{{ item.dosageInstruction[0].text }}</td>
                    </tr>
