    ...
    <AuthenticatedLayout>
        ...
        <div class="h-screen flex flex-row pt-4 xl:pt-7">
            ...
            <div v-show="formSection === 2" class="min-h-full px-5 md:px-10 xl:pl-80 xl:pr-14 pb-10 w-full">
                <div class="bg-original-white-0 shadow rounded-xl md:rounded-2xl mb-8 p-6 md:py-8 md:px-10">
                    <h1 class="text-2xl font-bold text-secondhand-orange-300">Data Triase dan Gawat Darurat</h1>
                    <div class="flex flex-col lg:flex-row">
                        <!-- Kiri -->
                        <div class="w-full lg:w-1/2 py-2 lg:pr-7 lg:pb-0">
                            <h2 class="text-xl font-semibold text-secondhand-orange-300">a. Sarana Transportasi Kedatangan</h2>
                            <div class="space-y-4">
                                <SaranaTransport :encounter_reference="encounter_reference" :subject_reference="subject_ref" :practitioner_reference="practitioner_ref" />
                            </div>
                            <h2 class="text-xl font-semibold text-secondhand-orange-300">b. Surat Pengantar Rujukan</h2>
                            <div class="space-y-4">
                                <SuratRujukan :encounter_reference="encounter_reference" :subject_reference="subject_ref" :practitioner_reference="practitioner_ref" />
                            </div>
                        </div>
                        <!-- Kanan -->
                        <div class="w-full lg:w-1/2 py-2 lg:pl-7">
                            <h2 class="text-xl font-semibold text-secondhand-orange-300">c. Kondisi Pasien Tiba</h2>
                            <div class="space-y-4">
                                <KondisiPasienTiba :encounter_reference="encounter_reference" :subject_reference="subject_ref" :practitioner_reference="practitioner_ref" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div v-show="formSection === 3" class="min-h-full px-5 md:px-10 xl:pl-80 xl:pr-14 pb-10 w-full">
                <div class="bg-original-white-0 shadow rounded-xl md:rounded-2xl mb-8 p-6 md:py-8 md:px-10">
                    <h1 class="text-2xl font-bold text-secondhand-orange-300">Anamnesis dan Psikologis</h1>
                    <div class="flex flex-col lg:flex-row">
                        <!-- Kiri -->
                        <div class="w-full lg:w-1/2 py-2 lg:pr-7 lg:pb-0">
            ...
            <div v-show="formSection === 4" class="min-h-full px-5 md:px-10 xl:pl-80 xl:pr-14 pb-10 w-full">
                <div class="bg-original-white-0 shadow rounded-xl md:rounded-2xl mb-8 p-6 md:py-8 md:px-10">
                    <h1 class="text-2xl font-bold text-secondhand-orange-300">Asesmen Awal IGD</h1>
                    <div class="flex flex-col lg:flex-row">
                        <!-- Kiri -->
                        <div class="w-full lg:w-1/2 py-2 lg:pr-7 lg:pb-0">
                            <h2 class="text-xl font-semibold text-secondhand-orange-300">a. Asesmen Nyeri</h2>
                            <div class="space-y-4">
                                <AsesmenNyeri :encounter_reference="encounter_reference" :subject_reference="subject_ref" :practitioner_reference="practitioner_ref" />
                                <SkalaNyeriNRS :encounter_reference="encounter_reference" :subject_reference="subject_ref" :practitioner_reference="practitioner_ref" />
                                <SkalaNyeriBPS :encounter_reference="encounter_reference" :subject_reference="subject_ref" :practitioner_reference="practitioner_ref" />
                                
                                <Arms ref="arms" :encounter_reference="encounter_reference" :subject_reference="subject_ref" :practitioner_reference="practitioner_ref" />
                                <BreathingPattern ref="breathingpattern" :encounter_reference="encounter_reference" :subject_reference="subject_ref" :practitioner_reference="practitioner_ref" />
                                <Cry ref="cry" :encounter_reference="encounter_reference" :subject_reference="subject_ref" :practitioner_reference="practitioner_ref" />
                                <FacialExpression ref="facialexpression" :encounter_reference="encounter_reference" :subject_reference="subject_ref" :practitioner_reference="practitioner_ref" />
                                <Legs ref="legs" :encounter_reference="encounter_reference" :subject_reference="subject_ref" :practitioner_reference="practitioner_ref" />
                                <StateofArousal ref="stateofarousal" :encounter_reference="encounter_reference" :subject_reference="subject_ref" :practitioner_reference="practitioner_ref" />
                                <TotalScoreNIPS ref="totalscorenips" :encounter_reference="encounter_reference" :subject_reference="subject_ref" :practitioner_reference="practitioner_ref" />
                                <div class="w-full flex justify-end mt-2 pr-3">
                                    <MainButtonSmall @click="nipsSubmit" class="teal-button text-original-white-0">Submit
                                    </MainButtonSmall>
                                </div>
                                
                                <DurasiNyeri :encounter_reference="encounter_reference" :subject_reference="subject_ref" :practitioner_reference="practitioner_ref" />
                                <LokasiNyeri :encounter_reference="encounter_reference" :subject_reference="subject_ref" :practitioner_reference="practitioner_ref" />
                                <FrekuensiNyeri :encounter_reference="encounter_reference" :subject_reference="subject_ref" :practitioner_reference="practitioner_ref" />
                                <PenyebabNyeri :encounter_reference="encounter_reference" :subject_reference="subject_ref" :practitioner_reference="practitioner_ref" />
                            </div>
                            <h2 class="text-xl font-semibold text-secondhand-orange-300">b. Kajian Risiko Jatuh</h2>
                            <div class="space-y-4">
                                <MorseFallScale :encounter_reference="encounter_reference" :subject_reference="subject_ref" :practitioner_reference="practitioner_ref" />
                                <HumptyDumptyScale :encounter_reference="encounter_reference" :subject_reference="subject_ref" :practitioner_reference="practitioner_ref" />
                                <EPFRA :encounter_reference="encounter_reference" :subject_reference="subject_ref" :practitioner_reference="practitioner_ref" />
                            </div>
                        </div>
                        <!-- Kanan -->
                        <div class="w-full lg:w-1/2 py-2 lg:pl-7">
                            ...
                            <div class="space-y-4">
                                ...
                                <Langit ref="langit" :encounter_reference="encounter_reference" :subject_reference="subject_ref" :practitioner_reference="practitioner_ref"  />
                                ...
                                <div class="w-full flex justify-end mt-2 mr-3">
                                    <MainButtonSmall :isLoading="fisikIsLoading" @click="fisikSubmit" class="teal-button text-original-white-0">Submit
                                    </MainButtonSmall>
                                </div>
                            </div>
                        </div>
            ...
            <div v-show="formSection === 5" class="min-h-full px-5 md:px-10 xl:pl-80 xl:pr-14 pb-10 w-full">
                <div class="bg-original-white-0 shadow rounded-xl md:rounded-2xl mb-8 p-6 md:py-8 md:px-10">
                    <h1 class="text-2xl font-bold text-secondhand-orange-300">Skrining</h1>
                    <div class="flex flex-col lg:flex-row">
                        <!-- Kiri -->
                        <div class="w-full lg:w-1/2 py-2 lg:pr-7 lg:pb-0">
                            <h2 class="text-xl font-semibold text-secondhand-orange-300">a. Risiko Luka Decubitus</h2>
                            <div class="space-y-4">
                                <RisikoLukaDecubitus :encounter_reference="encounter_reference" :subject_reference="subject_ref" :practitioner_reference="practitioner_ref"  />
                            </div>
                            <h2 class="text-xl font-semibold text-secondhand-orange-300">b. Batuk</h2>
                            <div class="space-y-4">
                                <Batuk :encounter_reference="encounter_reference" :subject_reference="subject_ref" :practitioner_reference="practitioner_ref"  />
                            </div>
                        </div>
                        <!-- Kanan -->
                        <div class="w-full lg:w-1/2 py-2 lg:pl-7">
                            <h2 class="text-xl font-semibold text-secondhand-orange-300">c. Gizi</h2>
                            <div class="space-y-4">
                                <Gizi :encounter_reference="encounter_reference" :subject_reference="subject_ref" :practitioner_reference="practitioner_ref"  />
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <template #responsivecontent>
            ...
            <ResponsiveNavButton @click="formSection = 2" :active="formSection === 2"> 2. Triase dan Gawat Darurat
            </ResponsiveNavButton>
            <ResponsiveNavButton @click="formSection = 3" :active="formSection === 3"> 3. Anamnesis & Pemeriksaan Psikologis
            </ResponsiveNavButton>
            <ResponsiveNavButton @click="formSection = 4" :active="formSection === 4"> 4. Asesmen Awal IGD
            </ResponsiveNavButton>
            <ResponsiveNavButton @click="formSection = 5" :active="formSection === 5"> 5. Skrining
            </ResponsiveNavButton>
            <ResponsiveNavButton @click="formSection = 6" :active="formSection === 6"> 6. Diagnosis
            </ResponsiveNavButton>
            <ResponsiveNavButton @click="formSection = 7" :active="formSection === 7"> 7. Tindakan
            </ResponsiveNavButton>
            <ResponsiveNavButton @click="formSection = 8" :active="formSection === 8"> 8. Rencana Tindak Lanjut
            </ResponsiveNavButton>
...
import SaranaTransport from '@/Pages/FormRekamMedis/DataTriaseDanGawatDarurat/SaranaTransport.vue';
import SuratRujukan from '@/Pages/FormRekamMedis/DataTriaseDanGawatDarurat/SuratRujukan.vue';
import KondisiPasienTiba from '@/Pages/FormRekamMedis/DataTriaseDanGawatDarurat/KondisiPasienTiba.vue';

import AsesmenNyeri from '@/Pages/FormRekamMedis/AsesmenAwalGawatDarurat/AsesmenNyeri/AsesmenNyeri.vue';
import DurasiNyeri from '@/Pages/FormRekamMedis/AsesmenAwalGawatDarurat/AsesmenNyeri/DurasiNyeri.vue';
import LokasiNyeri from '@/Pages/FormRekamMedis/AsesmenAwalGawatDarurat/AsesmenNyeri/LokasiNyeri.vue';
import FrekuensiNyeri from '@/Pages/FormRekamMedis/AsesmenAwalGawatDarurat/AsesmenNyeri/FrekuensiNyeri.vue';
import PenyebabNyeri from '@/Pages/FormRekamMedis/AsesmenAwalGawatDarurat/AsesmenNyeri/PenyebabNyeri.vue';
import SkalaNyeriBPS from '@/Pages/FormRekamMedis/AsesmenAwalGawatDarurat/AsesmenNyeri/SkalaNyeriBPS.vue';
import SkalaNyeriNRS from '@/Pages/FormRekamMedis/AsesmenAwalGawatDarurat/AsesmenNyeri/SkalaNyeriNRS.vue';
import Arms from '@/Pages/FormRekamMedis/AsesmenAwalGawatDarurat/AsesmenNyeri/NIPS/Arms.vue';
import BreathingPattern from '@/Pages/FormRekamMedis/AsesmenAwalGawatDarurat/AsesmenNyeri/NIPS/BreathingPattern.vue';
import Cry from '@/Pages/FormRekamMedis/AsesmenAwalGawatDarurat/AsesmenNyeri/NIPS/Cry.vue';
import FacialExpression from '@/Pages/FormRekamMedis/AsesmenAwalGawatDarurat/AsesmenNyeri/NIPS/FacialExpression.vue';
import Legs from '@/Pages/FormRekamMedis/AsesmenAwalGawatDarurat/AsesmenNyeri/NIPS/Legs.vue';
import StateofArousal from '@/Pages/FormRekamMedis/AsesmenAwalGawatDarurat/AsesmenNyeri/NIPS/StateofArousal.vue';
import TotalScoreNIPS from '@/Pages/FormRekamMedis/AsesmenAwalGawatDarurat/AsesmenNyeri/NIPS/TotalScoreNIPS.vue';
import MorseFallScale from '@/Pages/FormRekamMedis/AsesmenAwalGawatDarurat/KajianJatuh/MorseFallScale.vue';
import HumptyDumptyScale from '@/Pages/FormRekamMedis/AsesmenAwalGawatDarurat/KajianJatuh/HumptyDumptyScale.vue';
import EPFRA from '@/Pages/FormRekamMedis/AsesmenAwalGawatDarurat/KajianJatuh/EPFRA.vue';

import RisikoLukaDecubitus from '@/Pages/FormRekamMedis/Skrining/RisikoLukaDecubitus.vue';
import Gizi from '@/Pages/FormRekamMedis/Skrining/Gizi.vue';
import Batuk from '@/Pages/FormRekamMedis/Skrining/Batuk.vue';
...
// NIPS
const arms = ref(null);
const breathingpattern = ref(null);
const cry = ref(null);
const facialexpression = ref(null);
const legs = ref(null);
const stateofarousal = ref(null);
const totalscorenips = ref(null);
const nipsSubmit = () => {
    arms.value.submit();
    breathingpattern.value.submit();
    cry.value.submit();
    facialexpression.value.submit();
    legs.value.submit();
    stateofarousal.value.submit();
    totalscorenips.value.submit();
};
...
const fisikIsLoading = ref(false);
// Pemeriksaan Fisik
