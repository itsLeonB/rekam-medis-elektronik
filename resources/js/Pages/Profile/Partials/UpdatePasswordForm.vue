    ...
    <section>
        <header>
            ...
            <p class="mt-1 text-sm text-gray-600">
                Pastikan untuk menggunakan password yang aman.
            </p>
        </header>
        ...
        <form @submit.prevent="updatePassword" class="mt-6 space-y-6">
            ...
            <div class="flex items-center gap-4">
                ...
                >
                    <p v-if="form.recentlySuccessful" class="text-sm text-original-teal-300">Perubahan password berhasil tersimpan.</p>
                </Transition>
            </div>
        </form>
    </section>
