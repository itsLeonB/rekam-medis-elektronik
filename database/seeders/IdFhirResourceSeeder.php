...
class IdFhirResourceSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        foreach ($files as $f) {
            ...
            switch ($resType) {
                case 'Organization':
                    $processor->generateOrganization($res, $resText);
                    break;
                case 'Location':
                    $processor->generateLocation($res, $resText);
                    break;
                case 'Practitioner':
                    $processor->generatePractitioner($res, $resText);
                    break;
                case 'Patient':
                    $processor->generatePatient($res, $resText);
                    break;
                case 'Encounter':
                    $processor->generateEncounter($res, $resText);
                    break;
                    // case 'Condition':
