    ...
    private function baseDataRules($prefix): array
    {
        return array_merge(
            [
                ...
                $prefix . 'hospitalization_preadmission_identifier_use' => ['nullable', Rule::in(Constants::IDENTIFIER_USE)],
                ...
                $prefix . 'hospitalization_diet_preference.*.code' => ['required', Rule::in(Codesystems::Diet['code'])],
                $prefix . 'hospitalization_special_arrangement' => 'nullable|array',
                $prefix . 'hospitalization_special_arrangement.*.code' => ['required', Rule::in(Codesystems::SpecialArrangements['code'])],
