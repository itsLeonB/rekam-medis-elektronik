...
class FhirRequest extends FormRequest
{
    ...
    public function getTimingDataRules(string $prefix = null): array
    {
        return array_merge(
            [
                ...
                $prefix . 'repeat.when.*' => ['nullable', Rule::in(MedicationRequestDosage::REPEAT_WHEN_CODE)],
    ...
    public function getDosageDataRules(string $prefix = null): array
    {
        return array_merge(
            ...
            $this->getCodeableConceptDataRules($prefix . 'dosage_data.route_', MedicationRequestDosage::ROUTE_CODE),
            ...
            $this->getCodeableConceptDataRules($prefix . 'dose_rate.', MedicationRequestDosageDoseRate::TYPE_CODE),
