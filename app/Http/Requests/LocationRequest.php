...
class LocationRequest extends FhirRequest
{
    ...
    private function baseDataRules($prefix): array
    {
        return [
            ...
            $prefix . 'province' => ['nullable', Rule::exists(Location::ADMINISTRATIVE_CODE['binding']['valueset']['table'], 'nama_prov')],
            $prefix . 'city' => ['nullable', Rule::exists(Location::ADMINISTRATIVE_CODE['binding']['valueset']['table'], 'nama_kabko')],
            $prefix . 'district' => ['nullable', Rule::exists(Location::ADMINISTRATIVE_CODE['binding']['valueset']['table'], 'nama_kec')],
            $prefix . 'village' => ['nullable', Rule::exists(Location::ADMINISTRATIVE_CODE['binding']['valueset']['table'], 'nama_kel')],
