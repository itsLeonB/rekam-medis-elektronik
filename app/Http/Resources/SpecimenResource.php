...
class SpecimenResource extends FhirResource
{
    ...
    {
        $specimen = $this->getData('specimen');

        $data = $this->resourceStructure($specimen);
