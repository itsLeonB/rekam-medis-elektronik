...
class SpecimenCondition extends Model
{
    ...
    public const DEFINITION = ["AUT" => "Sampel hasil diautolisasi", "CFU" => "Sampel hasil sentrifugasi", "CLOT" => "Sampel hasil pembekuan darah", "CON" => "Sampel terkontaminasi", "COOL" => "Sampel dalam kondisi dingin", "FROZ" => "Sampel dala kondisi beku", "HEM" => "Sampel dalam kondisi terhemolisis", "LIVE" => "Sampel hidup", "ROOM" => "Sampel pada suhu ruangan"];
